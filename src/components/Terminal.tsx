...
const TERMINAL_LINES: TerminalLine[] = [
  ...
  { output: "Jay Chauhan — Backend & AI Engineer @ Arhamshare", delay: 400 },
  { prompt: "jay@dev ~$", command: " cat skills.json", delay: 800 },
  { output: '<span class="string">{ "backend": "Python, FastAPI, WebSockets" }</span>', delay: 1200 },
  { output: '<span class="string">{ "ai": "LangChain, Qdrant, Groq LLaMA, RAG" }</span>', delay: 1400 },
  { output: '<span class="string">{ "devops": "Docker, NGINX, PostgreSQL, Redis" }</span>', delay: 1600 },
  { prompt: "jay@dev ~$", command: " git log --oneline -3", delay: 2200 },
  { output: '<span class="keyword">a3f21b8</span> feat: add RAG pipeline with Qdrant retrieval', delay: 2600 },
  { output: '<span class="keyword">e7c94d2</span> fix: optimize WebSocket stream latency', delay: 2800 },
  { output: '<span class="keyword">1b5fa39</span> refactor: FastAPI microservice architecture', delay: 3000 },
