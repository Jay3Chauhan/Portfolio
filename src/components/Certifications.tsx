...
// Ordered with the most current/relevant (GenAI) first within the technical group.
const TECHNICAL_CERTS: Cert[] = [
  {
    issuer: "AWS",
...
/** Single source of truth for the "Certifications" stat shown in the Hero. */
export const CERTIFICATIONS_COUNT = TECHNICAL_CERTS.length + RECOGNITION_CERTS.length;
  ...
  return (
    <section id="certifications">
      <div className="section-container">
        ...
        <ScrollReveal>
          <h3 className="certs-group-title">Technical Certifications</h3>
        </ScrollReveal>
        <div className="certs-grid">
          {TECHNICAL_CERTS.map((cert, i) => (
        ...
        <ScrollReveal>
          <h3 className="certs-group-title certs-group-title-secondary">
            Leadership &amp; Recognition
          </h3>
        </ScrollReveal>
        <div className="certs-grid">
          {RECOGNITION_CERTS.map((cert, i) => (
            <ScrollReveal key={i} delay={cert.delay}>
              <div className="cert-card cert-card-recognition">
                {cert.badge && (
                  <div className="cert-badge-wrap">
                    <Image
                      src={cert.badge}
